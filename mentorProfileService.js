...
const getAllMentorMatches = () => {
    const config = {
        method: 'GET',
        url: mentorProfileApi + `/mentormatches`,
        crossdomain: true,
        withCredentials: true,
        headers: { 'Content-Type': 'application/json' },
    };
...
const getMentorMatchesPage = (index, size) => {
    const config = {
        method: 'GET',
        url: mentorProfileApi + `/mentormatches?pageIndex=${index}&pageSize=${size}`,
        crossdomain: true,
        withCredentials: true,
        headers: { 'Content-Type': 'application/json' },
    };
